namespace OAuthTest
{
    ...
    public partial class Callback : System.Web.UI.Page
    {
        ...
        private const string clientId = "00000000400E961A";

        // Make sure this is identical to the redirect_uri parameter passed in WL.init() call.
        private const string callback = "/Live/Callback.aspx";
        private const string clientSecret = "mt5xKUkCsi1029bQ1jYAIUmV-dZ-RnQe";
